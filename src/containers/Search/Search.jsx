...
const Search = () => {
    ...
    const handleSeeAll = (id, type) => {
        history.push(`/app/search/${searchValue.toLowerCase()}/${type}`, {
            id,
        });
    };
                        ...
                        <SearchContainer>
                            ...
                            <TopResultContainer>
                                ...
                                <TopResult
                                    ...
                                    title={
                                        list?.artists?.items[0]?.name ||
                                        list.tracks.items[0].name
                                    }
                                    cover={
                                        list?.artists?.items[0]?.images[0]
                                            ?.url ||
                                        list?.tracks.items[0]?.album?.images[0]
                                            .url
                                    }
                                    type={
